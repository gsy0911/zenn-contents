...
:::message
Raspberry Pi 5 の金額が高くなっていて驚きました（もっと早くに買っておけばよかったと後悔しています・・・）。ちなみに家にはRaspberry Pi 3 もあったのですが、メモリが1GBと非力だったので Raspberry Pi 5 を新規購入しました。
:::
...
:::message
ビルドは M1 MacBook Pro で 1 時間くらいかかりました。
:::
